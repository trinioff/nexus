 ...
 * camera at the hand's projected position. The ring tightens on a pinch and opens a
 * little on an open hand; it fades out when no hand is tracked. Reads the hand store;
 * knows nothing about MediaPipe.
 */
export function HandCursor() {
  ...
  useFrame(({ camera }, delta) => {
    ...
    if (visible) {
      ...
      g.position.copy(camera.position).addScaledVector(point, CURSOR_DISTANCE);
    }
